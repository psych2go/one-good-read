...
if (automationEnabled && !new Set([...compatibleProviders, "workers-ai"]).has(vars.EMBEDDING_PROVIDER)) errors.push("EMBEDDING_PROVIDER must be workers-ai, openai, or openai-compatible before automation is enabled");
