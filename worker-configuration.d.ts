/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7103aedec65ef30885372e1c662543d)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	CONTENT: R2Bucket;
	DB: D1Database;
	ARTICLE_VECTORS: VectorizeIndex;
	WORKERS_AI: Ai;
	ASSETS: Fetcher;
	APP_NAME: "One Good Read";
	APP_ORIGIN: "https://read.zhuying.fun";
	AI_PROVIDER: "openai-compatible";
	AI_MODEL: "gpt-5.6-luna";
	AI_BASE_URL: "https://wangzixiang.eu.org";
	ANALYSIS_VERSION: "blind-v1-context-v1";
	EMBEDDING_PROVIDER: "workers-ai";
	EMBEDDING_MODEL: "@cf/baai/bge-small-en-v1.5";
	EMBEDDING_BASE_URL: "";
	EMBEDDING_DIMENSIONS: "384";
	EMBEDDING_VERSION: "embedding-v1";
	PREFERENCE_MODEL_VERSION: "ridge-v1";
	SELECTION_VERSION: "selection-v2-semantic";
	ADMIN_EMAIL: "zhuyingqiuhua@gmail.com";
	ACCESS_TEAM_DOMAIN: "https://aaron-bjtu.cloudflareaccess.com";
	ACCESS_AUD: "5f52c1d816a02ab2a34e3fc39925169d6b60c8aea40b1b4477aa2ce85d5cefad";
	ALERTS_ENABLED: "false";
	ALERT_TO_EMAIL: "";
	ALERT_FROM_EMAIL: "";
	ALERT_WEBHOOK_URL: "";
	R2_STORAGE_LIMIT_BYTES: "10000000000";
	AUTOMATION_ENABLED: "true";
	BACKFILL_ENABLED: "true";
	RESERVOIR_TARGET: "300";
	RESERVOIR_BATCH_SIZE: "3";
	RESERVOIR_SOURCES_PER_RUN: "4";
	SIMULATION_ENABLED: "false";
	SIMULATION_DAYS_REQUIRED: "7";
	LOCAL_ADMIN_BYPASS: string;
	DAILY_WORKFLOW: Workflow<Parameters<import("./src/index").DailyReadingWorkflow['run']>[0]['payload']>;
	BACKFILL_WORKFLOW: Workflow<Parameters<import("./src/index").BackfillWorkflow['run']>[0]['payload']>;
	RESERVOIR_WORKFLOW: Workflow<Parameters<import("./src/index").ReservoirWorkflow['run']>[0]['payload']>;
	SIMULATION_WORKFLOW: Workflow<Parameters<import("./src/index").SimulationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_ORIGIN" | "AI_PROVIDER" | "AI_MODEL" | "AI_BASE_URL" | "ANALYSIS_VERSION" | "EMBEDDING_PROVIDER" | "EMBEDDING_MODEL" | "EMBEDDING_BASE_URL" | "EMBEDDING_DIMENSIONS" | "EMBEDDING_VERSION" | "PREFERENCE_MODEL_VERSION" | "SELECTION_VERSION" | "ADMIN_EMAIL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ALERTS_ENABLED" | "ALERT_TO_EMAIL" | "ALERT_FROM_EMAIL" | "ALERT_WEBHOOK_URL" | "R2_STORAGE_LIMIT_BYTES" | "AUTOMATION_ENABLED" | "BACKFILL_ENABLED" | "RESERVOIR_TARGET" | "RESERVOIR_BATCH_SIZE" | "RESERVOIR_SOURCES_PER_RUN" | "SIMULATION_ENABLED" | "SIMULATION_DAYS_REQUIRED" | "LOCAL_ADMIN_BYPASS">> {}
}
